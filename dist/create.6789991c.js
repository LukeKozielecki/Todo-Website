...
})({"cGJCX":[function(require,module,exports) {
...
async function loadTask(id) {
    ...
    } else console.error("Failed to load task:", response);
}
form.addEventListener("submit", async (e)=>{
    ...
    let res;
    if (taskId) //PUT call for update old
    res = await (0, _task.Task).update(taskData);
    else //POST call for save new
    res = await (0, _task.Task).save(taskData);
    if (!res.ok) console.log("Not able to save task");
    else window.location.href = "/";
});
async function generateTaskId() {
    const tasks = await (0, _task.Task).loadAll();
...
const Task = new (0, _data.TaskClass)("http://localhost:3000/task");

},{"../services/data":"jnZMj","@parcel/transformer-js/src/esmodule-helpers.js":"a2Vou"}],"jnZMj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "TaskClass", ()=>TaskClass);
class TaskClass {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"a2Vou"}],"a2Vou":[function(require,module,exports) {
...
},{}]},["cGJCX","4WE0n"], "4WE0n", "parcelRequire45ad")
